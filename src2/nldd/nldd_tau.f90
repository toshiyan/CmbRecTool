...
subroutine Kernels_tau(rL,eL,WA,WB,X,kernel)
...
subroutine AlTT_tau(rL,eL,Att,fC,OCTT,ITT)
  implicit none
  !I/O
  ...
  S0 = 0d0
  call Kernels_tau(rL,eL,W1,W2,S0,'S0')

  W2 = W1 * fC(rL(1):rL(2))
  G0 = 0d0
  call Kernels_tau(rL,eL,W2,W2,G0,'G0')
