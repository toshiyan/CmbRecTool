...
$key = q/eq:pixel_l/;
$external_labels{$key} = "$URL/" . q|intronode7.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:quadtree/;
$external_labels{$key} = "$URL/" . q|intronode3.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:Numbering/;
$external_labels{$key} = "$URL/" . q|intronode4.htm|; 
$noresave{$key} = "$nosave";
