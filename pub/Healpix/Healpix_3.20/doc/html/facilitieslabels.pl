...
$key = q/page:defdir/;
$external_labels{$key} = "$URL/" . q|facilitiesnode2.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/eq:alteralm/;
$external_labels{$key} = "$URL/" . q|facilitiesnode5.htm|; 
$noresave{$key} = "$nosave";

$key = q/fac:hotspot/;
$external_labels{$key} = "$URL/" . q|facilitiesnode7.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/fac:map2gif/;
$external_labels{$key} = "$URL/" . q|facilitiesnode8.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/fac:anafast/;
$external_labels{$key} = "$URL/" . q|facilitiesnode6.htm|; 
$noresave{$key} = "$nosave";
