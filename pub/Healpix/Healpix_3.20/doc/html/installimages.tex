...
\providecommand{\gdlversion}{0.9.2 } 
\hypersetup{%
...
\providecommand{\healpixmail}{{\em healpix-support} {\tt at} {\em lists.sourceforge.net}}%
\providecommand{\healpixsupport}{http://healpix.sourceforge.net/support.php} 
%
